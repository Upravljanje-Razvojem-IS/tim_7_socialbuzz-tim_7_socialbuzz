...
namespace AdMicroservice.Controllers
{
    ...
    public class PastPriceController : ControllerBase
    {
        ...
        public PastPriceController(IPastPriceRepository pastPriceRepository, IMapper mapper, LinkGenerator linkGenerator, ILoggerMockRepository logger, IHttpContextAccessor contextAccessor, IProductRepository productRepository, IServiceRepository serviceRepository)
        {
        ...
        public ActionResult<List<PastPrice>> GetPastPriceById(Guid itemForSaleId)
        {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPost]
        public ActionResult<PastPrice> CreatePastPrice([FromBody] PastPriceCreationDTO pastPriceCreationDTO)
        {
            try
            {
                ...
                //prosla cena mora da se odnosi na neki proizvod ili uslugu
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        [HttpPut("{pastPriceId}")]
        public ActionResult<PastPrice> UpdatePastPrice([FromBody] PastPriceDto pastPriceDto, int pastPriceId)
        {
            try
            {
        ...
        public IActionResult DeletePastPrice(int pastPriceId)
        {
            try
            {
